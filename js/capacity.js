...
if (effectiveRate >= 0.65 && estimateCount >= 12) {
  ...
  if (score >= 80) {
    stars = "★★★★★";
    rank = "かなり余地あり";
    comment = "この候補地は、追加POIを置ける余地が大きく、イベント時の分散歩行にも向いています。";
  } else if (score >= 60) {
    stars = "★★★★☆";
    rank = "余地あり";
    comment = "この候補地は、追加POIを置ける余地があります。配置を工夫すれば、バランスの良いキャンプサイトにできます。";
  } else if (score >= 40) {
    stars = "★★★☆☆";
    rank = "工夫が必要";
    comment = "一定の配置余地はありますが、既存POI密度や追加位置の選定に注意が必要です。";
  } else if (score >= 20) {
    stars = "★★☆☆☆";
    rank = "配置余地は少なめ";
  }
