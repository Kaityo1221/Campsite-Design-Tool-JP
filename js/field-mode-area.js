(() => {
  ...
  async function exportCombinedKmz(){
    ...
    const newRecords=poiRecords.filter(r=>r.added&&r.isNew&&!r.fieldDeleted);appendNewPois(doc,documentNode,newRecords,photoPaths);appendGeneratedCircles(doc,documentNode,newRecords);appendAreas(doc,documentNode);
