(() => {
  ...
  function createPoiAtLatLng(latlng){
    ...
    const record={marker,rangeCircle,name,description:'',folder:additionalFolderName(type.value),latlng:[...latlng],originalLatlng:[...latlng],added:true,isNew:true,poiType:type.value,include30mCircle:false,fieldMemo:'',fieldMemoDirty:false,fieldPhoto:null,fieldPhotoDirty:false,fieldDeleted:false};
