    ...(() => {
      // iPhone/Safari data recovery layer.
      // This keeps GCS acquisition/recovery only. It must not paint POIs or
      // project coordinates into a Bridge-owned map overlay.
